...
with tab_prono:
    ...
    if not race.empty:
        ...
        st.dataframe(race[["horse_number", "horse_name", "jockey", "trainer", "odds", "draw", "weight", "recent_form"]], use_container_width=True, hide_index=True)
...
with tab_model:
    ...
    if not is_configured():
        ...
        if not versions.empty:
            ...
            st.dataframe(versions[["id", "created_at", "model_type", "test_top1", "ROI top1", "is_active", "artifact_hash"]], use_container_width=True, hide_index=True)
